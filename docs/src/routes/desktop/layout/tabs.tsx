...
import { CodeBlock, Paragraph, Tabs, Title } from "@dreamer/ui-preact";
...
import { Tabs } from "@dreamer/ui-preact";

const activeKey = signal("a");
const items = [
...
export default function LayoutTabs() {
  ...
  return (
    <div class="space-y-10">
      ...
      {
        /*
         * 须直接渲染 `<Tabs />`。文档站为 `jsxImportSource: preact`，**函数子节点 `{() => ...}` 不会被调用**，
         * 示例区会空白，浏览器 E2E 也永远找不到 `[role="tab"]`。（getter 岛屿为 @dreamer/view 编译链路语义，此处不适用。）
         */
      }
