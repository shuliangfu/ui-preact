/**
 * Google Chrome 品牌 Logo，24×24，来源 Simple Icons (official shape)。
 */
...
/** Google Chrome 品牌 Logo 图标 */
export function IconBrandChrome(props?: IconComponentProps): JSX.Element {
