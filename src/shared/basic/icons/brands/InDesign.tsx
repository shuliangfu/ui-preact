...
const svg = (
  <svg viewBox="0 0 240 234" fill="none" class="w-full h-full" aria-hidden>
    ...
    <path
      fill="#FF3366"
      d="m87.2 61.2v103c0 1.1-0.5 1.6-1.4 1.6h-19.6c-0.9 0-1.3-0.5-1.3-1.6v-103c0-0.9 0.5-1.3 1.4-1.3h19.5c0.6-0.1 1.2 0.3 1.3 1 0.1 0.1 0.1 0.2 0.1 0.3z"
    />
    <path
      fill="#FF3366"
...
export function IconBrandIndesign(props?: IconComponentProps): JSX.Element {
