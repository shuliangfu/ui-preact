/**
 * **Saint Barthélemy** 国旗。ISO: `BL`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Saint Barthélemy — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagBL(props?: CountryFlagComponentProps): JSX.Element {
