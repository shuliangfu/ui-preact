/**
 * **Italy** 国旗。ISO: `IT`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Italy — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagIT(props?: CountryFlagComponentProps): JSX.Element {
