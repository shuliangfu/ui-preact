/**
 * **Liberia** 国旗。ISO: `LR`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Liberia — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagLR(props?: CountryFlagComponentProps): JSX.Element {
