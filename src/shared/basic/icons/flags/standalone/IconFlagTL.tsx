/**
 * **Timor-Leste** 国旗。ISO: `TL`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Timor-Leste — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagTL(props?: CountryFlagComponentProps): JSX.Element {
