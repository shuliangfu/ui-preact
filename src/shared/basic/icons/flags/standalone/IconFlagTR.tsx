/**
 * **Türkiye** 国旗。ISO: `TR`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Türkiye — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagTR(props?: CountryFlagComponentProps): JSX.Element {
