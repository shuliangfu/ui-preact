/**
 * **Samoa** 国旗。ISO: `WS`；只含该国 SVG，**勿手改**（`build-country-flags.mts` 生成）。
...
/**
 * Samoa — 1:1 独立文件；只 import 本文件不会打入他国。
 */
export function IconFlagWS(props?: CountryFlagComponentProps): JSX.Element {
