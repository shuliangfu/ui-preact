/**
 * @module @dreamer/ui-preact/shared
 *
 * **当前范围**：**basic**、**form**（含 DatePicker、PickerCalendarNav 等）、**layout**、**navigation**、**feedback**、**data-display**（Calendar、Tag、Empty、Statistic、Segmented、Descriptions、Card、List 等）。
 */
