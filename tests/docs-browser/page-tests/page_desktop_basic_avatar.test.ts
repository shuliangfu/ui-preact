/**
 * @fileoverview 文档路由 `/desktop/basic/avatar` 的浏览器测试。
 * Avatar 头像 — **本文件仅服务该路由**：后续请按文档示例块继续补全分步交互与断言，勿用仓库脚本覆盖正文。
...
describe("文档页 E2E：/desktop/basic/avatar（Avatar 头像）", () => {
  ...
  /**
   * 文档小节「首字（children）」：在 main 内定位对应 h3，于该示例区块内完成一次交互。
   */
  ...
  /**
   * 文档小节「图片 src 与 alt」：在 main 内定位对应 h3，于该示例区块内完成一次交互。
   */
  ...
  /**
   * 文档小节「class 自定义样式」：在 main 内定位对应 h3，于该示例区块内完成一次交互。
   */
