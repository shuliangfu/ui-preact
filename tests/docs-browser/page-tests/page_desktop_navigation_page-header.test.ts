/**
 * @fileoverview 文档路由 `/desktop/navigation/page-header` 的浏览器测试。
 * PageHeader 页头 — **本文件仅服务该路由**：后续请按文档示例块继续补全分步交互与断言，勿用仓库脚本覆盖正文。
...
const DOC_PATH = "/desktop/navigation/page-header";

describe("文档页 E2E：/desktop/navigation/page-header（PageHeader 页头）", () => {
  ...
  /**
   * 文档小节「完整用法」：在 main 内定位对应 h3，于该示例区块内完成一次交互。
   */
  it("严格·完整用法", async (t) => {
    if (!t?.browser?.goto) return;
